...
func jsonAuthFail(w http.ResponseWriter) {
	w.Header().Add("WWW-Authenticate", `Basic realm="cashwallet RPC"`)
...
// method.  This may be a request that is handled directly by cashwallet, or
// a chain server request that is handled by passing the request down to gcash.
//
