...
[![GoDoc](https://godoc.org/github.com/bcext/cashwallet/walletdb?status.png)]
(http://godoc.org/github.com/bcext/cashwallet/walletdb)
...
http://localhost:6060/pkg/github.com/bcext/cashwallet/walletdb

## Installation

```bash
$ go get github.com/bcext/cashwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/bcext/cashwallet/walletdb#example-package--BasicUsage)  
