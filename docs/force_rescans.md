...
cashwallet will not drop transaction history by itself, as this is something that
...
```
$ cd $GOPATH/src/github.com/bcext/cashwallet/cmd/dropwtxmgr
$ go get
```
...
```
$ dropwtxmgr
Database path: /home/username/.cashwallet/mainnet/wallet.db
Drop all cashwallet transaction history? [y/N] y
...
```
$ dropwtxmgr --db ~/.cashwallet/testnet/wallet.db
Database path: /home/username/.cashwallet/testnet/wallet.db
Drop all cashwallet transaction history? [y/N] y
Dropping wtxmgr namespace
```

After dropping transaction history, cashwallet may be restarted and a full rescan
