...
//	[]wire.OutPoint
//	[]*wire.OutPoint
//	map[wire.OutPoint]cashutil.Address
//	[]chainhash.Hash
//	[]*chainhash.Hash
func (c *BitcoindClient) LoadTxFilter(reset bool, filters ...interface{}) error {
	...
	for _, filter := range filters {
		...
		case []cashutil.Address, []wire.OutPoint, []*wire.OutPoint,
			map[wire.OutPoint]cashutil.Address, []chainhash.Hash,
			[]*chainhash.Hash:
...
func (c *BitcoindClient) Rescan(blockHash *chainhash.Hash,
	addresses []cashutil.Address, outPoints map[wire.OutPoint]cashutil.Address) error {
